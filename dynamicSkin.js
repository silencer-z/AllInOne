...
importModule.import(function(lib, game, ui, get, ai, _status){
	...
	- 所有相关的文件请放到扩展内部/assets/dynamic目录下；
	- 关于格式请参考下面示例：
		武将名:{
			皮肤名:{
	...
	*/
	...
	let extend = {
		re_baosanniang: AIO.dynamicSkin.baosanniang,
		re_daqiao: AIO.dynamicSkin.daqiao,
		re_diaochan: AIO.dynamicSkin.diaochan,
		re_huangyueying: AIO.dynamicSkin.huangyueying,
		re_panshu: AIO.dynamicSkin.panshu,
		re_sunluban: AIO.dynamicSkin.sunluban,
		re_sunluyu: AIO.dynamicSkin.sunluyu,
		re_sunshangxiang: AIO.dynamicSkin.sunshangxiang,
		re_wangyi: AIO.dynamicSkin.wangyi,
		ol_xiaoqiao: AIO.dynamicSkin.re_xiaoqiao,
		re_xinxianying: AIO.dynamicSkin.xinxianying,
		ol_zhangchangpu: AIO.dynamicSkin.zhangchangpu,
		re_zhenji: AIO.dynamicSkin.zhenji,
	};
	// TODO 在AIO中添加对应的get.extend方法
