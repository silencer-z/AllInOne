'use strict';
AIO.import(function (lib, game, ui, get, ai, _status) {
	AIO.component = {
		...
		chatBox: function () {
			var box = AIO.dialog.create('chat-box folded');
			box.container = AIO.dialog.create('container', box);
			box.operation = AIO.dialog.create('operation', box);
			box.content = AIO.dialog.create('content', box.container);

			box.operation.fold = AIO.dialog.create('fold-button', box.operation, 'button');
			box.operation.input = AIO.dialog.create('chat-input', box.operation, 'input');
			box.operation.sticker = AIO.dialog.create('sticker-button', box.operation, 'button');
			box.operation.send = AIO.dialog.create('send-button', box.operation, 'button');
			...
			box.addEntry = function (info) {
				var text = AIO.dialog.create('chat-text', box.content);
